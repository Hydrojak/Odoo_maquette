...
class SavMagasinSavCreateWizard(models.TransientModel):
    ...
    _description = "Assistant de création rapide dossier batterie"
    ...
    device_name = fields.Char(string="Batterie")
    ...
    def _create_order(self):
        ...
        if not self.device_name:
            raise ValidationError(_("Le batterie est obligatoire."))
        if not self.symptom:
    ...
    def action_create_and_print_deposit(self):
        order = self._create_order()
        return order.action_print_deposit()
